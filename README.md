...
[![CI](https://github.com/PlatformStackPulse/tf-atom-wafv2-ip-set-aws/actions/workflows/ci.yml/badge.svg)](https://github.com/PlatformStackPulse/tf-atom-wafv2-ip-set-aws/actions/workflows/ci.yml)
[![Release](https://github.com/PlatformStackPulse/tf-atom-wafv2-ip-set-aws/actions/workflows/auto-release.yml/badge.svg)](https://github.com/PlatformStackPulse/tf-atom-wafv2-ip-set-aws/actions/workflows/auto-release.yml)
[![CodeQL](https://github.com/PlatformStackPulse/tf-atom-wafv2-ip-set-aws/actions/workflows/codeql.yml/badge.svg)](https://github.com/PlatformStackPulse/tf-atom-wafv2-ip-set-aws/actions/workflows/codeql.yml)
![Terraform](https://img.shields.io/badge/terraform-%3E%3D1.6.0-blueviolet)
[![Latest Release](https://img.shields.io/github/v/release/PlatformStackPulse/tf-atom-wafv2-ip-set-aws)](https://github.com/PlatformStackPulse/tf-atom-wafv2-ip-set-aws/releases)

---

## Purpose

Terraform atom module for a single AWS WAFv2 IP Set resource. Manages a set of IP addresses (IPv4 or IPv6 CIDR blocks) for use in WAF rules to allow or block traffic.
...
| <a name="input_addresses"></a> [addresses](#input\_addresses) | List of IP addresses or CIDR blocks in the IP set. | `list(string)` | `[]` | no |
...
| <a name="output_ip_set_arn"></a> [ip\_set\_arn](#output\_ip\_set\_arn) | The ARN of the WAFv2 IP Set. |
| <a name="output_ip_set_id"></a> [ip\_set\_id](#output\_ip\_set\_id) | The ID of the WAFv2 IP Set. |
<!-- END_TF_DOCS -->
